...
const password_service_1 = require("../src/platform/security/password.service");
...
const DEMO_ADMIN_PASSWORD = process.env.SUPER_ADMIN_PASSWORD ?? 'Admin@SmartLight2026';
const DEMO_CUSTOMER_EMAIL = process.env.DEMO_CUSTOMER_EMAIL ?? 'customer@smartlight.vn';
const DEMO_CUSTOMER_PASSWORD = process.env.DEMO_CUSTOMER_PASSWORD ?? 'Customer@SmartLight2026';
...
const ATTRIBUTE_SEEDS = [
    { code: 'power', displayName: 'Công suất', unit: 'W', dataType: client_1.AttributeDataType.TEXT, isFilterable: true, isRequired: true, sortOrder: 1 },
    { code: 'color-temp', displayName: 'Nhiệt độ màu', unit: 'K', dataType: client_1.AttributeDataType.TEXT, isFilterable: true, isRequired: false, sortOrder: 2 },
    { code: 'voltage', displayName: 'Điện áp', unit: 'V', dataType: client_1.AttributeDataType.TEXT, isFilterable: false, isRequired: false, sortOrder: 3 },
    { code: 'lifetime', displayName: 'Tuổi thọ', unit: 'h', dataType: client_1.AttributeDataType.NUMBER, isFilterable: false, isRequired: false, sortOrder: 4 },
    { code: 'warranty', displayName: 'Bảo hành', unit: 'tháng', dataType: client_1.AttributeDataType.NUMBER, isFilterable: false, isRequired: false, sortOrder: 5 },
    { code: 'dimmable', displayName: 'Có thể điều chỉnh', dataType: client_1.AttributeDataType.BOOLEAN, isFilterable: true, isRequired: false, sortOrder: 6 },
    { code: 'beam-angle', displayName: 'Góc chiếu', unit: '°', dataType: client_1.AttributeDataType.NUMBER, isFilterable: false, isRequired: false, sortOrder: 7 },
    { code: 'color-rendering', displayName: 'Chỉ số hoàn màu (CRI)', unit: 'Ra', dataType: client_1.AttributeDataType.NUMBER, isFilterable: false, isRequired: false, sortOrder: 8 },
];
/* =============================================================================
...
const PRODUCT_SEEDS = [
    {
        ...
        description: 'Đèn LED âm trần SmartLight X1 siêu mỏng, chỉ 2cm. Tuổi thọ 25.000 giờ, bảo hành 24 tháng. CRI ≥ 80 cho ánh sáng trung thực. Phù hợp phòng khách, phòng ngủ, hành lang.',
    ...
    },
    {
        ...
        description: 'Bóng đèn LED Philips 9W thay thế bóng sợi đốt 60W. Ánh sáng trắng ấm 3000K, đuôi E27 phổ thông. Tuổi thọ 15.000 giờ, bảo hành chính hãng 24 tháng.',
    ...
    },
    {
        ...
        description: 'Bóng đèn LED Rạng Đông 7W tiết kiệm điện. Bảo hành chính hãng 24 tháng. Ánh sáng trắng ấm 3000K, CRI ≥ 80.',
        categorySlug: 'den-led-bulb',
        brandSlug: 'rang-dong',
        basePrice: 32000,
...
const PROMOTION_WELCOME = {
    ...
    description: 'Voucher chào mừng khách hàng mới. Giảm 10% cho đơn hàng từ 200.000 VND.',
    type: client_1.PromotionType.PERCENTAGE,
    scope: client_1.DiscountScope.ORDER,
    discountValue: 10,
...
const VOUCHER_WELCOME = {
    code: 'WELCOME10',
    type: client_1.VoucherType.PUBLIC,
    usageLimit: 1000,
    perUserLimit: 1,
...
async function seedSuperAdmin() {
    ...
    const passwordHash = await (0, password_service_1.hashPassword)(DEMO_ADMIN_PASSWORD);
...
async function seedDemoCustomer() {
    ...
    const passwordHash = await (0, password_service_1.hashPassword)(DEMO_CUSTOMER_PASSWORD);
...
async function seedWelcomePromotion() {
    ...
    const promotion = await prisma.promotion.upsert({
        ...
        create: {
            ...
            priority: 100,
            stackable: false,
            usageLimitType: client_1.UsageLimitType.TOTAL,
            usageLimit: 1000,
        },
    });
    ...
    console.log(`[seed]   ${PROMOTION_WELCOME.discountValue}% off, min ${PROMOTION_WELCOME.minimumOrderValue} VND, max ${PROMOTION_WELCOME.maximumDiscount} VND`);
}
async function main() {
    console.log('');
    console.log('============================================================');
